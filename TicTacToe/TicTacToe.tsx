...
const TicTacToe = () => {
    /*
        go to defintion 정의로 가기를 활용하자!
    */
    const [state, dispatch] = useReducer(reducer, initialState); // 타이핑이 안되면 제네릭 <React.Reducer<ReducerState, ReducerActions>>
